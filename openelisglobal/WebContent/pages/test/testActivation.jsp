...
<script type="text/javascript">
    ...
    function configureForSort() {
        $jq("#step").text('<%=StringUtil.getMessageForKey("label.testActivationSort")%>');
...
<span id="testActivationSort" class="selectHide sortShow" style="display:none" ><%= StringUtil.getMessageForKey("label.testActivationSort") %></span>
