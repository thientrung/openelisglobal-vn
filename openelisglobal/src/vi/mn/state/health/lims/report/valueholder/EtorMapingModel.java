...
public class EtorMapingModel {
	...
	/**
	 * @param sampleCondition the sampleCondition to set
	 */
	...
	/**
	 * @param patientBedNumber the patientBedNumber to set
	 */
	...
	/**
	 * @param patientRoomNumber the patientRoomNumber to set
	 */
	...
	/**
	 * @param organizationLocalAbbrev the organizationLocalAbbrev to set
	 */
	...
	/**
	 * @return the sampItemId
	 */
	public String getSampItemId() {
		return sampItemId;
	}
	/**
	 * @param sampItemId the sampItemId to set
	 */
	public void setSampItemId(String sampItemId) {
		this.sampItemId = sampItemId;
	}
	/**
	 * @return the lisStatus
	 */
	public String getLisStatus() {
		return lisStatus;
	}
	/**
	 * @param lisStatus the lisStatus to set
	 */
