...
public interface IPatientUpdate {
	...
	public abstract ActionMessages preparePatientData(ActionMapping mapping,
			HttpServletRequest request, PatientManagementInfo patientInfo)
			throws IllegalAccessException, InvocationTargetException,
			NoSuchMethodException;

	public abstract void setPatientUpdateStatus(
			PatientManagementInfo patientInfo);

	public abstract PatientUpdateStatus getPatientUpdateStatus();

	public abstract String persistPatientData(PatientManagementInfo patientInfo)
