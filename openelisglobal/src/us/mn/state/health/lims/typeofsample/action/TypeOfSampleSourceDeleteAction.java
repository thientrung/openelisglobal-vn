 ...
 */
public class TypeOfSampleSourceDeleteAction extends BaseAction {
	...
	protected ActionForward performAction(ActionMapping mapping,
		...
		try {
			...
			typeOfSampleSourceDAO.deleteData(selectedIDs, currentUserId);

			tx.commit();
		} catch (LIMSRuntimeException lre) {
			LogEvent.logError("TypeOfSampleSourceDeleteAction","performAction()",lre.toString());
			tx.rollback();
        ...
        request.setAttribute("menuDefinition", "TypeOfSampleSourceDefinition");
