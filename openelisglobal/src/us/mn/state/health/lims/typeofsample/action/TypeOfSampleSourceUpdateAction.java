 ...
 */
public class TypeOfSampleSourceUpdateAction extends BaseAction {
...
//		}
		...
		String sourceOfSampleId = (String)dynaForm.get("source");	
		
		TypeOfSampleSource sampleSource = new TypeOfSampleSource();
		sampleSource.setSourceId(sourceOfSampleId);
		sampleSource.setTypeOfSampleId(typeOfSampleId);
		sampleSource.setSysUserId(currentUserId);
		
		TypeOfSampleSourceDAO sampleSourceDAO = new TypeOfSampleSourceDAOImpl();
		try{
			sampleSourceDAO.insertData(sampleSource);
