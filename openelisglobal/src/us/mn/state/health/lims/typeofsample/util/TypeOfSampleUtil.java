...
public class TypeOfSampleUtil {
    ...
    public static List<Test> getTestListBySampleTypeId(String sampleTypeId, boolean orderableOnly,List<Integer> testIds) {

        List<Test> testList = createSampleIdTestMap(sampleTypeId,testIds);

        /*if (testList == null) {
            testList = sampleIdTestMap.get(sampleTypeId);
        }*/
	...
	private static List<Test> createSampleIdTestMap(String sampleTypeId,List<Integer> testIds) {
        List<Test> testList;
        TypeOfSampleTestDAO sampleTestsDAO = new TypeOfSampleTestDAOImpl();
        List<TypeOfSampleTest> tests = sampleTestsDAO.getTypeOfSampleTestsForSampleType(sampleTypeId,testIds);
