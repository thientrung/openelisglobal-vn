...
public class AccessionNumberUtil {
	...
	public static IAccessionNumberValidator getAccessionNumberValidator() {
		if (accessionNumberValidator == null) {
			try {
				...
				LogEvent.logFatal("AccessionNumberUtil",
						"getAccessionNumberValidator", e.toString());
			}
		}
	...
	public static String getNextAccessionNumber(String optionalPrefix)
			throws IllegalStateException {
		return getAccessionNumberValidator().getNextAvailableAccessionNumber(
				optionalPrefix);
	}
	...
	public static ValidationResults checkAccessionNumberValidity(
		...
		try {
			return getAccessionNumberValidator().checkAccessionNumberValidity(
	...
	public static ValidationResults isSampleStatusValid(String accessionNumber,
			RecordStatus validStatus) {
		StatusSet statusSet = StatusService.getInstance()
				.getStatusSetForAccessionNumber(accessionNumber);
	...
	public static ValidationResults correctFormat(String accessionNumber,
		...
		return getAccessionNumberValidator().validFormat(accessionNumber,
				validateYear);
	}

	public static boolean isUsed(String accessionNumber) {
		return getAccessionNumberValidator().accessionNumberIsUsed(
				accessionNumber, null);
	}

	// Dung add check in sample in database
	public static boolean isHadDataAccessionNumber(String accessionNumber) {
		return getAccessionNumberValidator().accessionNumberNotInTheSystem(
				accessionNumber, null);
	}

	public static String getAccessionNumberFromSampleItemAccessionNumber(
