...
public class ProviderDAOImpl extends BaseDAOImpl implements ProviderDAO {
	...
	public void deleteData(List providers) throws LIMSRuntimeException {
		...
		try {
			...
			// bugzilla 2154
			LogEvent.logError("ProviderDAOImpl", "AuditTrail deleteData()",
					e.toString());
			throw new LIMSRuntimeException(
					"Error in Provider AuditTrail deleteData()", e);
		}
	...
	public String insertDataWS(Provider provider) throws LIMSRuntimeException {
		String id = null;
		try {
			id = (String) HibernateUtil.getSession().save(provider);
			provider.setId(id);
	...
	public void updateData(Provider provider) throws LIMSRuntimeException {
		...
		try {
			...
			// bugzilla 2154
			LogEvent.logError("ProviderDAOImpl", "AuditTrail updateData()",
					e.toString());
			throw new LIMSRuntimeException(
					"Error in Provider AuditTrail updateData()", e);
		}
	...
	public void getData(Provider provider) throws LIMSRuntimeException {
		try {
			Provider prov = (Provider) HibernateUtil.getSession().get(
					Provider.class, provider.getId());
			HibernateUtil.getSession().flush();
			HibernateUtil.getSession().clear();
			if (prov != null) {
	...
	public List getAllProviders() throws LIMSRuntimeException {
		...
		try {
			...
			// bugzilla 2154
			LogEvent.logError("ProviderDAOImpl", "getAllProviders()",
					e.toString());
			throw new LIMSRuntimeException(
					"Error in Provider getAllProviders()", e);
		}
	...
	public List getPageOfProviders(int startingRecNo)
		...
		try {
			...
			// bugzilla 2154
			LogEvent.logError("ProviderDAOImpl", "getPageOfProviders()",
					e.toString());
			throw new LIMSRuntimeException(
					"Error in Provider getPageOfProviders()", e);
		}
	...
	public Provider readProvider(String idString) {
		...
		try {
			provider = (Provider) HibernateUtil.getSession().get(
					Provider.class, idString);
			HibernateUtil.getSession().flush();
			HibernateUtil.getSession().clear();
		} catch (Exception e) {
			// bugzilla 2154
			LogEvent.logError("ProviderDAOImpl", "readProvider()", e.toString());
			throw new LIMSRuntimeException("Error in Provider readProvider()",
					e);
		}
	...
	public Provider getProviderByPerson(Person person)
		...
		try {
			...
			LogEvent.logError("ProviderDAOImpl", "getProviderByPerson()",
					e.toString());
			throw new LIMSRuntimeException(
					"Error in Provider getProviderByPerson()", e);
		}
