...
public class PILogbook extends Report implements IReportCreator {
	private String paramMenu;
	
	public PILogbook(String inParamMenu) {
	...
	protected String reportFileName() {
		...
		if (ReportFileNameAndParams.Param_PILogbook.equals(paramMenu)) {
			reportFileName = ReportFileNameAndParams.Report_PILogbook;
        }
