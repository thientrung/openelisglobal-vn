 /**
 * @(#) ParameterPatientType.java 01-00 Sep 18, 2016
 * 
 ...
 * @author haql
 */
public class ParameterPatientType implements Serializable {
    private static final long serialVersionUID = 1L;
    private final String label;
    private final List<IdValuePair> list;
    private String selection;

    public ParameterPatientType(List<IdValuePair> list, String label) {
        this.label = label;
        this.list = list;
    }
