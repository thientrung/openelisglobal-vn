 ...
 */
public class ReportSpecificationListName implements Serializable{
    ...
    public ReportSpecificationListName( List<IdValuePair> list, String label){
        this.label = label;
        this.list = list;
    }
    ...
    public void setRequestParameters( BaseActionForm dynaForm ){
        try{
            PropertyUtils.setProperty( dynaForm, "selectListName", this );
