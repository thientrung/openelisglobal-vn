...
public class BaseDAOImpl implements BaseDAO, IActionConstants {
     ...
     * (non-Javadoc)
     * 
     * @see us.mn.state.health.lims.common.dao.BaseDAO#getNextRecord(java.lang.String, java.lang.String,
     *      java.lang.Class) passing in id of current record -> get next and check if there will be more (next button
     *      enabled?)
     */
