 ...
 *         used by the struts action classes. bugzilla 2053 cleaning up
 *         routing/forwarding constants
 */
public interface IActionConstants  {
	...
	public static final String FWD_VALIDATION_ERROR_ACCESSION_NUMBER = "errorAccess";
	public static final String FWD_SUCCESS = "success";
	// dung add
	public static final String FWD_SUCCESS_NUMBER = "successNumber";
	...
	// bugzilla 1992 cleanup: These two forwards are for batch results
	// verification (View - only particular test and ViewAll - all tests by
	// accn#)
	...
	// bugzilla 2028 routing to QA Events Entry from Results/Batch Results Entry
	// Update Action if UNSATISFACTORY results
	...
	public static final int VALIDATION_PAGING_SIZE = 100;

	/**
	 * The system_module name used to determine if the current user is allowed
	 * to edit primary patient IDs (subject number & site subject number).
	 */
	...
	// Dũng add
	public static final String NAME_SHOW_TEST_COMBOBOX = "Ch\u1ECDn m\u1EABu th\u1EED c\u1EA7n t\u00ECm:";
	public static final String NAME_SHOW_PROJECT_DENGUE = "Ch\u1ECDn d\u1EF1 \u00E1n Dengue:";
	public static final String NOT_FOUND_TEST_RESULT = "Not found test result ID in the system";
	public static final String OBSERVATION_TYPE_AGE_UNIT = "11";
	public static final String OBSERVATION_TYPE_AGE_VALUE = "10";
	public static final String OBSERVATION_TYPE_DEPARTMENT = "9";
	public static final String OBSERVATION_TYPE_DIAGNOSIS = "6";
	public static final String OBSERVATION_VALUE_TYPE_L = "L";
	public static final String OBSERVATION_VALUE_TYPE_D = "D";
	public static final String OBSERVATION_TYPE_SPECIES_NAME = "12";
	public static final String MTQG = "Gi\u00E1m s\u00E1t tr\u1ECDng \u0111i\u1EC3m";
	public static final String BCTX = "B\u00E1o c\u00E1o th\u01B0\u1EDDng xuy\u00EAn";
	// nhuql.gv ADD
	public static final String NAME_SHOW_ORGANIZATION_NAME_COMBOBOX = "Ch\u1ECDn c\u01A1 s\u1EDF y\u00EAu c\u1EA9u c\u1EA7n t\u00ECm:";
	public static final String PATIENT_ID = "patientID";
	public static final String CIRITERIA = "criteria";
	public static final String VALUE_SEARCH = "valueSearch";
	public static final String NOT_FOUND = "valueSearch";

	public static final String FOUND_ACCESSION_NUMBER = "Error found to use the accession number ";
	public static final String NOT_FOUND_ACCESSION_NUMBER = "Error not found the accession number in the system ";
	public static final String NOT_FOUND_TEST = "Not found test ID in the system ";
	public static final String NOT_FOUND_PROVIDER = "Not have a provider ID";
	public static final String NOT_FOUND_TYPE_OF_SAMPLE = "Not found type of sample ID in the system ";
	public static final String AgeUnits = "Not found test result ID in the system";
	
	public static final String VALIDATION_BY_ACCESSION_NUMBER = "ResultValidationByAccessionNumber";
	public static final String VALIDATION = "ResultValidation";
	public static final String LOGBOOK_RESULTS = "LogbookResults";
	// Added by Trung
	public static final Integer DISTRICT_CATEGORY_ID = 240;
	public static final Integer CITY_CATEGORY_ID = 239;
	public static final Integer CITY_SORT_ORDER = 0;

	public static final Integer MODIFY_ORDER_MODULE_ID = 118;
	public static final Integer MODIFY_ORDER_SEARCH_MODULE_ID = 106;
	public static final Integer MODIFY_FULLORDER_MODULE_ID = 1255;
	public static final Integer MODIFY_FULLORDER_SEARCH_MODULE_ID = 123;
	public static final Integer INVENTORY_MODULE_ID = 18;
	public static final Integer NONCOMFORMITY_MODULE_ID = 107;
	
    public static final Integer UNKNOWN_PERSON_ID = 115;
    public static final Integer MAX_STRING_ARRAY_LENGTH = 99;
    public static final String STR_SAMPLE_ID_OBS_HISTORY_REFERENCE = "1";
    public static final String STR_TEST_RESULT_TYPE_ID = "4";

    public static final String OUT_OF_RANGE_LOW = "L";
    public static final String OUT_OF_RANGE_HIGH = "H";
